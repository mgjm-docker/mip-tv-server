...
const getGeoip = async ip => {
	...
	if(!data) return {location: {lat: null, long: null}, country: 'Unknown'};
	// return the interesting data
	return {
		location: data.location ? {lat: data.location.latitude, long: data.location.longitude} : {lat: null, long: null},
